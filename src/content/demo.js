...
export const iconsBlock = {
  text: "Works with your technologies",
  icons: [
    { isAnchor: true, name: "react" },
    { isAnchor: true, name: "tailwindcss" },
    { isAnchor: false, name: "svelte" },
    { isAnchor: true, name: "astro" },
    { isAnchor: false, name: "vercel" },
    { isAnchor: true, name: "alpinedotjs" },
  ],
};
